    ...
    <div>
      ...
      <div className="bg-white">
        ...
        <main>
          ...
          {/* #TODO: CTA Section; currently disabled but to be re-enabled upon launch and to repalce the email notification section below */}
          {/* <div className="bg-white">
          ...
          {/* #TODO: Email notification section: To be used to allow people to register during the beta period to receive notification of our public launch date */}
                  ...
                  <div className="relative">
                    <div className="sm:text-center">
                      ...
                      <p className="mt-6 mx-auto max-w-2xl text-lg text-indigo-200">
                        We're currently in closed beta, but please let us know your email address if you'd like us to contact you when
